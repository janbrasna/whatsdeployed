...
Development requires Python installed for the backend, and NodeJS with Yarn
for the frontend.
...
```
DEBUG=1 SQLALCHEMY_DATABASE_URI='postgresql:///whatsdeployed' ./app.py
```
...
DEBUG=1
SQLALCHEMY_DATABASE_URI='postgresql:///whatsdeployed'
```
